define('editor',["require", "exports", "tslib", "./savedata", "./file-utils", "aurelia-framework"], function (require, exports, tslib_1, savedata_1, file_utils_1, aurelia_framework_1) {
    ...
    var Editor = (function () {
        ...
        Editor.prototype.load = function (buffer) {
            this.buffer = buffer;
            this.stream = savedata_1.HW2SaveStream.create(buffer);
        };
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
...
define('savedata',["require", "exports", "tslib", "libvantage"], function (require, exports, tslib_1, libvantage_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var HW2SaveStream = (function (_super) {
        tslib_1.__extends(HW2SaveStream, _super);
        function HW2SaveStream(buffer) {
            var _this = _super.call(this, new libvantage_1.MemoryStream(buffer)) || this;
            _this.buffer = buffer;
            return _this;
        }
        HW2SaveStream.create = function (buffer) {
            var ms = new libvantage_1.MemoryStream();
            var deflateStream = new libvantage_1.DeflateStream(new libvantage_1.MemoryStream(buffer), libvantage_1.CompressionMode.Decompress);
            deflateStream.copyTo(ms);
            deflateStream.close();
            return new HW2SaveStream(ms.getBuffer());
        };
        HW2SaveStream.prototype.getSaveData = function () {
            var ms = new libvantage_1.MemoryStream();
            var deflateStream = new libvantage_1.DeflateStream(new libvantage_1.MemoryStream(_super.prototype.getBuffer.call(this)), libvantage_1.CompressionMode.Compress);
            deflateStream.copyTo(ms);
            deflateStream.close();
            return ms.getBuffer();
        };
        return HW2SaveStream;
    }(libvantage_1.SaveStream));
    exports.HW2SaveStream = HW2SaveStream;
});

//# sourceMappingURL=data:application/json;charset=utf8;base64,
